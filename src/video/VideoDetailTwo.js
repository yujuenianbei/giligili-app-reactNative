...
class VideoDetailTwo extends Component {
    constructor(props) {
        super(props);
        this.state = {
            paused: true,
...
// 嵌套页面时要继承之前的
VideoDetailTwo.router = InfoNavigator.router;
...
export default connect(mapStateToProps, mapDispatchToProps)(VideoDetailTwo)
